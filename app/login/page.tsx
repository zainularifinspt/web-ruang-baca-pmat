...
export default function LoginPage() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-yellow-50/30 to-red-50/20 px-4 py-8 text-slate-950">
      {/* Background orbs from landing page backdrop */}
      <div className="animate-drift-slow pointer-events-none absolute -left-20 top-[-10%] size-[35rem] rounded-full bg-gradient-to-tr from-yellow-400/8 via-rose-400/6 to-transparent blur-[80px]" />
      <div className="animate-drift-reverse pointer-events-none absolute -right-20 top-[10%] size-[40rem] rounded-full bg-gradient-to-br from-orange-400/8 via-purple-400/6 to-transparent blur-[100px]" />
      <div className="animate-drift-slow pointer-events-none absolute left-[20%] top-[40%] size-[30rem] rounded-full bg-gradient-to-tr from-red-400/4 via-yellow-400/4 to-transparent blur-[90px]" />

      {/* Decorative math glyphs */}
      <div className="pointer-events-none absolute left-[5%] top-28 hidden select-none text-[11rem] font-light leading-none text-red-600/[0.03] lg:block">
        ∫
      </div>
      <div className="pointer-events-none absolute right-[8%] top-24 hidden select-none text-7xl font-semibold text-amber-600/[0.04] lg:block">
        Σ
      </div>
      <div className="pointer-events-none absolute bottom-28 left-[12%] hidden select-none text-3xl italic text-red-600/[0.04] lg:block">
        A = πr²
      </div>
      <div className="pointer-events-none absolute bottom-24 right-[12%] hidden select-none text-3xl italic text-orange-600/[0.04] lg:block">
        f(x) = x² - 4x + 3
      </div>
      ...
      <div className="relative flex min-h-[calc(100vh-4rem)] w-full max-w-6xl items-center justify-center">
        <div className="grid w-full max-w-5xl overflow-hidden rounded-[2.25rem] border border-white/40 bg-white/45 shadow-2xl shadow-slate-950/5 backdrop-blur-3xl lg:grid-cols-[0.92fr_1.08fr]">
          <section className="relative hidden overflow-hidden bg-gradient-to-br from-[#0c1424] via-[#090d16] to-[#030712] p-12 text-white lg:flex lg:flex-col lg:justify-between border-r border-white/5">
            ...
            <div className="animate-drift-slow pointer-events-none absolute -right-20 -top-20 size-80 rounded-full bg-gradient-to-br from-yellow-500/15 via-blue-500/5 to-transparent blur-3xl" />
            <div className="animate-drift-reverse pointer-events-none absolute bottom-[-10%] left-[-10%] size-80 rounded-full bg-gradient-to-tr from-red-500/15 via-yellow-500/5 to-transparent blur-3xl" />
            ...
            <Link href="/" className="group relative inline-flex items-center gap-3 transition-transform duration-300 hover:scale-[1.02]">
              <span className="flex items-center -space-x-2">
                <span className="flex size-11 items-center justify-center rounded-xl bg-gradient-to-br from-red-500 via-yellow-600 to-orange-600 text-white shadow-lg shadow-yellow-950/45 transition-transform duration-300 group-hover:scale-105">
              ...
              <div className="mb-8 flex items-center justify-between gap-4 lg:hidden">
                <Link href="/" className="inline-flex min-w-0 items-center gap-3">
                  <span className="flex shrink-0 items-center -space-x-2">
                    <span className="flex size-10 items-center justify-center rounded-xl bg-gradient-to-br from-red-500 via-yellow-600 to-orange-600 text-white shadow-md">
