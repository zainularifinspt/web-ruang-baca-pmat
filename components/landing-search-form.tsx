...
export function LandingSearchForm() {
  ...
  return (
    <form
      ...
      className="mx-auto flex w-full max-w-3xl items-center gap-2 rounded-full border border-white/50 bg-white/45 p-2 shadow-[0_24px_60px_rgba(8,145,178,0.06)] backdrop-blur-3xl ring-1 ring-slate-200/20 transition-all duration-500 focus-within:-translate-y-1 focus-within:border-cyan-300/80 focus-within:bg-white/75 focus-within:shadow-[0_32px_80px_rgba(8,145,178,0.12)] focus-within:ring-8 focus-within:ring-cyan-500/5"
    >
      <Search className="ml-4 size-5 shrink-0 text-cyan-600/70" />
      <input
        value={query}
      ...
      <button
        type="submit"
        className="inline-flex h-11 shrink-0 items-center justify-center gap-2 rounded-full bg-gradient-to-r from-emerald-600 via-cyan-600 to-indigo-600 px-6 text-sm font-bold text-white shadow-md shadow-emerald-950/10 transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-lg hover:shadow-emerald-950/20 active:scale-[0.99] sm:h-12 sm:px-8 border-0"
      >
