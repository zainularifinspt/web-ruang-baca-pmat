...
export function MathGeometricBackdrop() {
  return (
    ...
    >
      ...
      <div className="absolute top-8 left-3 sm:left-8 lg:left-14 animate-[float-slow_9s_ease-in-out_infinite]">
        <Icosahedron3D />
      </div>

      {/* 3. Top-Right: 3D Dodecahedron (Pentagonal Geometry) */}
      <div className="absolute top-10 right-3 sm:right-8 lg:right-16 animate-[float-reverse_11s_ease-in-out_infinite]">
        <Dodecahedron3D />
      </div>

      {/* 4. Mid-Left: 3D Octahedron (Diamond Crystal Dual-Pyramid) */}
      <div className="hidden sm:block absolute top-52 left-6 lg:left-20 animate-[float-reverse_8s_ease-in-out_infinite]">
        <Octahedron3D />
      </div>

      {/* 5. Mid-Right: 3D Torus Ribbon Knot (Topology) */}
      <div className="hidden sm:block absolute top-48 right-6 lg:right-20 animate-[float-slow_10s_ease-in-out_infinite]">
        <TorusKnot3D />
      </div>

      {/* 6. Floating 3D Glass Math Badges (Elegantly Scattered with Depth) */}
      {/* Integral Badge (Top Left Near Header) */}
      <div className="hidden md:block absolute top-28 left-[22%] animate-[float-slow_7s_ease-in-out_infinite]">
        <MathGlassBadge symbol="∫" label="f(x)dx" glow="#f43f5e" />
      </div>

      {/* Sigma Badge (Top Right Near Header) */}
      <div className="hidden md:block absolute top-24 right-[22%] animate-[float-reverse_8.5s_ease-in-out_infinite]">
        <MathGlassBadge symbol="∑" label="i=1..n" glow="#fb7185" />
      </div>

      {/* Pi Badge (Lower Left Flank) */}
      <div className="absolute bottom-28 left-4 sm:left-14 lg:left-28 animate-[float-slow_9.5s_ease-in-out_infinite]">
        <MathGlassBadge symbol="π" label="3.14159..." glow="#e11d48" />
      </div>

      {/* Infinity Badge (Lower Right Flank) */}
      <div className="absolute bottom-28 right-4 sm:right-14 lg:right-28 animate-[float-reverse_9s_ease-in-out_infinite]">
        <MathGlassBadge symbol="∞" label="limit" glow="#f43f5e" />
      </div>

      {/* Golden Ratio Phi Badge (Center Ambient Left) */}
      <div className="hidden lg:block absolute top-[65%] left-[8%] animate-[float-slow_8s_ease-in-out_infinite]">
        <MathGlassBadge symbol="Φ" label="1.618" glow="#fb7185" />
      </div>

      {/* Nabla / Delta Vector Operator Badge (Center Ambient Right) */}
      <div className="hidden lg:block absolute top-[62%] right-[8%] animate-[float-reverse_10s_ease-in-out_infinite]">
  ...
  return (
    <div className="relative group transition-transform duration-500 hover:scale-110">
      <svg
        ...
        height="130"
        viewBox="0 0 130 130"
        className="drop-shadow-[0_15px_35px_rgba(244,63,94,0.35)]"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <defs>
        ...
        <polygon points="65,32 94,80 36,80" fill="url(#icoF1)" stroke="rgba(255,255,255,0.4)" strokeWidth="1.2" />

        {/* Upper Facets */}
        <polygon points="65,12 65,32 36,80" fill="url(#icoF2)" stroke="rgba(255,255,255,0.3)" strokeWidth="1" />
        <polygon points="65,12 94,80 65,32" fill="url(#icoF1)" stroke="rgba(255,255,255,0.35)" strokeWidth="1" />
        <polygon points="65,12 108,35 94,80" fill="url(#icoF4)" stroke="rgba(255,255,255,0.25)" strokeWidth="0.9" />
        <polygon points="65,12 22,35 36,80" fill="url(#icoF3)" stroke="rgba(255,255,255,0.25)" strokeWidth="0.9" />

        {/* Lateral Flanking Facets */}
        <polygon points="22,35 36,80 16,92" fill="url(#icoF3)" stroke="rgba(255,255,255,0.25)" strokeWidth="0.9" />
        <polygon points="108,35 94,80 114,92" fill="url(#icoF2)" stroke="rgba(255,255,255,0.25)" strokeWidth="0.9" />

        {/* Bottom Facets */}
        <polygon points="36,80 65,118 94,80" fill="url(#icoF3)" stroke="rgba(255,255,255,0.35)" strokeWidth="1" />
        <polygon points="36,80 16,92 65,118" fill="url(#icoF2)" stroke="rgba(255,255,255,0.25)" strokeWidth="0.9" />
        <polygon points="94,80 114,92 65,118" fill="url(#icoF4)" stroke="rgba(255,255,255,0.25)" strokeWidth="0.9" />

        {/* Glowing 3D Vertices */}
        <circle cx="65" cy="12" r="2.5" fill="#ffffff" className="drop-shadow-[0_0_4px_#ffffff]" />
        <circle cx="65" cy="32" r="2.5" fill="#ffffff" className="drop-shadow-[0_0_4px_#ffffff]" />
        <circle cx="36" cy="80" r="2.5" fill="#ffffff" className="drop-shadow-[0_0_4px_#ffffff]" />
        <circle cx="94" cy="80" r="2.5" fill="#ffffff" className="drop-shadow-[0_0_4px_#ffffff]" />
        <circle cx="65" cy="118" r="2.5" fill="#ffffff" className="drop-shadow-[0_0_4px_#ffffff]" />
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="relative group transition-transform duration-500 hover:scale-110">
      <svg
        ...
        height="125"
        viewBox="0 0 110 125"
        className="drop-shadow-[0_15px_30px_rgba(225,29,72,0.35)]"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <defs>
        ...
        {/* Upper Pyramid Faces */}
        <polygon points="55,10 15,62 55,75" fill="url(#octTopLeft)" stroke="rgba(255,255,255,0.4)" strokeWidth="1.2" />
        <polygon points="55,10 95,62 55,75" fill="url(#octTopRight)" stroke="rgba(255,255,255,0.45)" strokeWidth="1.2" />

        {/* Lower Inverted Pyramid Faces */}
        <polygon points="55,115 15,62 55,75" fill="url(#octBotLeft)" stroke="rgba(255,255,255,0.35)" strokeWidth="1.2" />
        <polygon points="55,115 95,62 55,75" fill="url(#octBotRight)" stroke="rgba(255,255,255,0.3)" strokeWidth="1.2" />

        {/* Interior Wireframe Axis */}
        <line x1="55" y1="10" x2="55" y2="115" stroke="rgba(255,255,255,0.25)" strokeWidth="0.8" strokeDasharray="2 3" />
        <line x1="15" y1="62" x2="95" y2="62" stroke="rgba(255,255,255,0.2)" strokeWidth="0.8" strokeDasharray="2 3" />

        {/* Glowing Vertices */}
        <circle cx="55" cy="10" r="2.5" fill="#ffffff" className="drop-shadow-[0_0_5px_#ffffff]" />
        <circle cx="15" cy="62" r="2" fill="#ffffff" className="drop-shadow-[0_0_4px_#ffffff]" />
        <circle cx="95" cy="62" r="2" fill="#ffffff" className="drop-shadow-[0_0_4px_#ffffff]" />
        <circle cx="55" cy="75" r="2.5" fill="#ffffff" className="drop-shadow-[0_0_5px_#ffffff]" />
        <circle cx="55" cy="115" r="2.5" fill="#ffffff" className="drop-shadow-[0_0_5px_#ffffff]" />
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="relative group transition-transform duration-500 hover:scale-110">
      <svg
        ...
        height="130"
        viewBox="0 0 130 130"
        className="drop-shadow-[0_15px_35px_rgba(251,113,133,0.35)]"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <defs>
        ...
        {/* Glowing Vertices */}
        <circle cx="65" cy="16" r="2.5" fill="#ffffff" />
        ...
        <circle cx="51" cy="83" r="2.5" fill="#ffffff" />
        <circle cx="65" cy="118" r="2.5" fill="#ffffff" />
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="relative group transition-transform duration-500 hover:scale-110">
      ...
      >
        ...
        />
        <circle cx="60" cy="60" r="16" stroke="rgba(255,255,255,0.4)" strokeWidth="1.2" strokeDasharray="3 3" />
        <circle cx="60" cy="60" r="3" fill="#ffffff" className="drop-shadow-[0_0_6px_#ffffff]" />
      </svg>
    </div>
  );
}
...
function MathGlassBadge({
  ...
  return (
    <div
      className="inline-flex items-center gap-2 rounded-2xl px-3.5 py-2 backdrop-blur-xl border border-white/20 transition-all duration-300 hover:scale-108 hover:border-white/40 cursor-default"
      style={{
        background: "linear-gradient(135deg, rgba(255,255,255,0.12) 0%, rgba(20,4,8,0.65) 100%)",
        boxShadow: `0 15px 35px -8px rgba(0,0,0,0.6), inset 0 1px 0 0 rgba(255,255,255,0.3), 0 0 20px -3px ${glow}40`,
      }}
    >
      <span
